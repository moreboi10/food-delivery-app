...
import in.sanketmore.delivery.app.api.entity.OrderEntity;
...
import in.sanketmore.delivery.app.api.repository.OrderRepository;
...
//        orderRequest.put("amount",newOrder.getAmount());
        double amountInPaise = newOrder.getAmount() * 100;
...
//        existingOrder.setRazorpayPaymentId("razorpay_payment_id");
    ...
    private OrderEntity convertToEntity(OrderRequest request){
        System.out.println("ORDER ITEMS: " + request.getOrderedItems());
